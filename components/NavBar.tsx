...
export default function NavBar() {
  ...
  return (
    <nav className="fixed bottom-6 left-1/2 -translate-x-1/2 w-[90%] max-w-lg bg-white/90 backdrop-blur-xl border border-slate-200/50 shadow-2xl shadow-slate-200/50 rounded-3xl flex justify-around items-center py-3 px-4 z-50">
      {NAV_ITEMS.map(item => {
